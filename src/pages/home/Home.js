        ...
        <>
            <div className={`container-fluid ${css['bg-top']}`}>
                <div className="container">
                    ...
                    {/* content-top-home */}
                    <div className="row">
                        <div className={`col-lg-12 d-flex flex-column align-items-center ${css['content-top-home']}`}>
                            <h1 className={`text-center ${css["title-bar-top"]}`}>Minimal Furniture Store</h1>
                            <p className={`text-center ${css["desc-bar-top"]}`}>Donec nunc nunc, gravida vitae diam vel, varius interdum erat. Quisque a nunc vel diam auctor commodo.<br /> Curabitur blandit ultrices ex. Curabitur ut magna dignissim, dignissim</p>
                            <p className={`text-center ${css["explore-more"]}`}>Explore now</p>
            ...
            <div className={`container-fluid ${css["content-bottom-home"]}`}>
                <div className="row d-flex flex-column align-items-center">
                    <div className={`col-lg-7 col-md-12 col-sm-12 ${css["ceo"]}`}>
                        <p className={`text-center ${css['promo-home']}`}>Gave 5 stars for excellent customer service. I had a couple of questions which they replied quickly to answer. If I could give multiple reasons for my rating it would also be for the design quality and customization to go along with the great service. The theme is excellent, keep up the great work.</p>
